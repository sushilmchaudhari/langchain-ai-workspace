...
class CustomerReview(TypedDict):
    summary: Annotated[str, "A brief summary of the customer review in 50-70 words"]
    sentiment: Annotated[Literal["positive", "negative", "neutral"], "The overall sentiment of the review either positive, negative or neutral based on the content of the review"]
    pros: Annotated[Optional[list[str]], "A list of top 3 positive aspects mentioned in the review if available and explicitely mentioned as Pros:, otherwise empty list"]
    cons: Annotated[Optional[list[str]], "A list of top 3 negative aspects mentioned in the review if available and explicitely mentioned as Cons:, otherwise empty list"]
